...
public class PlayerControllerMovement : MonoBehaviour
{
    ...
    private GameObject tInventoryButton;
    private PlayerInventoryButton getInv;
    ...
    void Update()
    {
        ...
        if (canMove == true)
        {
            if (Ismoving == false)
            {
                if (getInv.closingInv == false)
                {
                    tInventoryButton.SetActive(true);
                    tDashButton.SetActive(false);
                }
            }
            ...
            if (Ismoving == true)
            {
                if (getInv.closingInv == false)
                {
                    tDashButton.SetActive(true);
                    tInventoryButton.SetActive(false);
                }
            }
